...
import ShareButton from "../reusable/share-button";
  ...
  return (
    <>
      <div className="flex justify-center items-center gap-x-10 h-15 shadow-md shadow-black/20 rounded-md lg:w-2xl mx-auto">
        ...
        <div className="flex gap-2 items-center">
          <Icon icon="raphael:view" width={30} className="text-gray-400" />
          <p>{data.views}</p>
        </div>
        <div className="flex gap-2 items-center">
          <Icon
      ...
      <div className="flex justify-center  lg:w-2xl mx-auto">
